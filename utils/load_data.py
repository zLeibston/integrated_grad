...
def load_MNIST_unnormalized(root="/mnt/e/datasets/data/MNIST",isTrain=True):
...
def load_CIFAR10_unnormalized(root="/mnt/e/datasets/data/CIFAR10",isTrain=True):
    transform = transforms.Compose([
        transforms.ToTensor(),
...
def get_MNIST_dataset(root="/mnt/e/datasets/data/MNIST",isTrain=True):
...
def get_CIFAR10_dataset(root="/mnt/e/datasets/data/CIFAR10",isTrain=True):
    transform = transforms.Compose([
        transforms.ToTensor(),
        transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010))
    ])
