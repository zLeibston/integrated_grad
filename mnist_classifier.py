...
class MnistClassifier(nn.Module):
    def __init__(self):
        super().__init__()
        self.cnn1 = nn.Conv2d(1, 10, kernel_size=3, padding=1)
        self.bn1 = nn.BatchNorm2d(10)
        self.pool = nn.MaxPool2d(2, 2)
        self.cnn2 = nn.Conv2d(10, 5, kernel_size=3, padding=1)
        self.bn2 = nn.BatchNorm2d(5)
        self.pool = nn.MaxPool2d(2, 2)

        self.fc1 = nn.Linear(245, 100)
    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            ...
            if accuracy > best_acc_in_val:
                ...
                best_epoch = epoch
                torch.save(model.state_dict(), "./models/best_mnist_classfier.pth")
                print("破纪录,当前最佳模型参数。")
