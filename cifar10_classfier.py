...
class Cifar10_Classifier(nn.Module):
    def __init__(self):
        super().__init__()
        self.cnn1 = nn.Conv2d(3, 32, kernel_size=3, padding=1)
    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            ...
            if accuracy > best_acc_in_val:
                ...
                best_epoch = epoch
                torch.save(model.state_dict(), "./models/best_cifar10_classfier.pth")
                print("破纪录,当前最佳模型参数。")
...
if __name__ == "__main__":
    ...
    train_loader ,val_loader= load_CIFAR10(isTrain=True)
    test_loader = load_CIFAR10(isTrain=False)
